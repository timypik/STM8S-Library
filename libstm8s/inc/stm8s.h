...
/*   Tip: To avoid modifying this file each time you need to switch between these
 ...
 # pragma message("T_CPU = STM8S208")
 # define T_CPU STM8S208
#elif defined (STM8S207)
 # pragma message("T_CPU = STM8S207")
 # define T_CPU STM8S207
#elif defined (STM8S105)
 # pragma message("T_CPU = STM8S105")
 # define T_CPU STM8S105
#elif defined (STM8S103)
 # pragma message("T_CPU = STM8S103")
 # define T_CPU STM8S103
#elif defined (STM8S903)
 # pragma message("T_CPU = STM8S903")
 # define T_CPU STM8S903
#elif defined (STM8AF52Ax)
 # pragma message("T_CPU = STM8AF52Ax")
 # define T_CPU STM8AF52Ax
#elif defined (STM8AF62Ax)
 # pragma message("T_CPU = STM8AF62Ax")
 # define T_CPU STM8AF62Ax
#elif defined (STM8AF626x)
 # pragma message("T_CPU = STM8AF626x")
 # define T_CPU STM8AF626x
#elif defined (STM8S007)
 # pragma message("T_CPU = STM8S007")
 # define T_CPU STM8S007
#elif defined (STM8S003)
 # pragma message("T_CPU = STM8S003")
 # define T_CPU STM8S003
#elif defined (STM8S005)
 # pragma message("T_CPU = STM8S005")
 # define T_CPU STM8S005
#endif
...
/* Check the used compiler */
 ...
 #undef  _IAR_SYSTEMS_
 #define _COSMIC_
 #pragma message("T_COMPILER = COSMIC")
 #define T_COMPILER COSMIC
#elif defined(__RCST7__)
 #undef  _COSMIC_
 #undef  _IAR_SYSTEMS_
 #define _RAISONANCE_
 #pragma message("T_COMPILER = RAISONANCE")
 #define T_COMPILER RAISONANCE
#elif defined(__IAR_SYSTEMS_ICC__)
 #undef  _COSMIC_
 #undef  _RAISONANCE_
 #define _IAR_SYSTEMS_
 #pragma message("T_COMPILER = IAR_SYSTEMS")
 #define T_COMPILER IAR_SYSTEMS
#else
...
/**
 ...
 #error "Please set HSE_VALUE (in stm8s.h file)"
#endif /* HSE_VALUE */
